...
const HorizontalScroll  = () => {
   ...
   const { height } = useDimension();
    ...
    console.log(projectLst)
    return(
        <div className="project-carousel w-full overflow-hidden py-30" ref={targetRef}>
            <motion.div className="project-wrapper w-fit flex gap-8" style={{x}}>
                {
                    projectLst.map((proj, index) => (
                        <div className="project-items bg-stone-800 text-white h-full overflow-hidden rounded-2xl w-110  flex-1 flex flex-col gap-4" key={index}>
