...
function Aesthetics(){
    return(
        <div className='w-full h-full relative proj-aesthetics proj-tile bg-stone-700' data-aos="fade-left" data-aos-easing="ease-in"  data-aos-offset="100" data-aos-delay="600" >
