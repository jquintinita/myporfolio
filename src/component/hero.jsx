...
function Hero(){
 ...
 return(
    <div className="hero-section flex  flex-col justify-center" id="home" ref={container}>
           <div className='container mx-auto px-4 md:px-10 lg:px-20'>
                <div className='flex flex-col-reverse  md:flex-row space-y-4 justify-between  md:place-items-center'>
                    <div className='intro-text '>
                        ...
                        <a href='/Joseph Quintinita-CV.pdf' target='_blank' className='bg-orange-500 text-white rounded-full font-medium inline-block py-4 px-9 ' data-aos="fade-up" data-aos-delay="250"   >Download CV</a>
                    </div>
