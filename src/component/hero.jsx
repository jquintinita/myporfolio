           ...
           <div className='container mx-auto px-4 md:px-10 lg:px-20'>
                <div className='flex flex-col-reverse  md:flex-row space-y-4 justify-between  md:place-items-center'>
                    <div className='intro-text '>
                        <div className='text-orange-500 intro-line text-md font-medium'>Meet the Developer</div>
                        <h1 className='text-stone-900 dark:text-white text-6xl lg:text-7xl xl:text-9xl font-bold'>Joseph <br/> Quintinita</h1>
                        <h2 className='text-stone-900 dark:text-white text-2xl font-medium dynamic-text'><span id="dynamic-text">{text}</span></h2>
                        <a href='/' className='bg-orange-500 text-white rounded-full font-medium inline-block py-4 px-9 '>Download CV</a>
                    </div>
                    <div className='logo-wrapper mb-9 md:mb-0'>
